        ...
        VStack(alignment: .leading, spacing: 12) {
            if model.worker == nil {
                ...
                if model.catalogOpenInCaptureOne {
                    Label("Capture One has this catalog open. If you have just changed something there, press Verify again before restoring, removing or moving files, so the app reads the catalog as it is now.",
